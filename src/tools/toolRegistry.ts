...
export const TOOLS: ToolDefinition[] = [
  ...
  { type: 'fibChannel', label: 'Fib Channel', category: 'gannFib', pointsRequired: 3 },
  { type: 'fibTimeZone', label: 'Fib Time Zone', category: 'gannFib', pointsRequired: 2 },
  { type: 'fibFan', label: 'Fib Fan', category: 'gannFib', pointsRequired: 2 },
  { type: 'fibArcs', label: 'Fib Arcs', category: 'gannFib', pointsRequired: 2 },
  { type: 'fibCircles', label: 'Fib Circles', category: 'gannFib', pointsRequired: 2 },
